...
in respective text files in ../QuestionTypes/ folder.
"""
...
Above method can be used to retrieve imageIds for given question Ids
or given question types or given answer types.
"""
ids = vqa.getImgIds()
